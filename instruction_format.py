...
def main():
    try:
        ...
        original_data = load_jsonl('data/standardized.jsonl')
        print(f"Loaded {len(original_data)} items from standardized.jsonl")
        ...
        write_jsonl(standardized_data, 'data/instruction_based_dataset.jsonl')

        print("Curated dataset is ready!")
    except Exception as e:
